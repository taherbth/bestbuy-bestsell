<?php 
	...
	<form method="post" enctype="multipart/form-data">
			...
			<div class="submit_my_interest_div" style="clear:both;"><input class="submit_my_interest" name="add_product_interest" id="add_product_interest" type="submit" value="<?php _e('Submit For Approval', 'TEXTDOMAIN'); ?>"></div>
