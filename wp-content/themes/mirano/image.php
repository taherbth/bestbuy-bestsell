...
switch($bloglayout) {
	...
	default:
		...
		$blogcolclass = 12;
		$blogsidebar = 'none';
		$road_postthumb = 'mirano-post-thumb'; //500x500px
}
?>
<div class="main-container page-wrapper">
	<div class="blog_header"><?php esc_html_e('Blog', 'mirano'); ?></div>
	<div class="container">
				...
				<div class="page-content blog-page single <?php echo esc_attr($blogclass); if($blogsidebar=='left') {echo ' left-sidebar'; } if($blogsidebar=='right') {echo ' right-sidebar'; } ?>">
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class( 'image-attachment' ); ?>>
							<div class="entry-content">
								...
								<div class="entry-description">
									<?php the_content(); ?>
									<?php wp_link_pages( array( 'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'mirano' ), 'after' => '</div>' ) ); ?>
								...
								<div class="post-info">
									...
									<footer class="entry-meta">
										<?php
											...
											printf( esc_html__( '<span class="meta-prep meta-prep-entry-date">Published </span> <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>.', 'mirano' ),
						...
						<!--<nav id="image-navigation" class="navigation nav-single" role="navigation">
							<span class="previous-image nav-previous"><?php previous_image_link( false, esc_html__( '&larr; Previous', 'mirano' ) ); ?></span>
							<span class="next-image nav-next"><?php next_image_link( false, esc_html__( 'Next &rarr;', 'mirano' ) ); ?></span>
