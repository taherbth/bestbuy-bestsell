...
class acf_location {
	...
	*/
	...
	function __construct() {
		...
		add_filter( 'acf/location/rule_types',		array($this, 'acf_location_rules_types'), 10, 3 ); // TAHER
		add_filter( 'acf/location/rule_operators',		array($this, 'acf_location_rules_operators'), 10, 3 ); // TAHER
		add_filter('acf/location/rule_values/user', array($this, 'acf_location_rules_values_user'), 10, 3 ); // TAHER		
	}
	// TAHER
